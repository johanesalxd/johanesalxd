...
🔬 **Current Project**: Developing custom data agents based on [ADK samples](https://github.com/johanesalxd/adk-samples/tree/main/python/agents/data-science), combining my data expertise with agentic AI capabilities.
...
**Tech Stack**: Go, BigQuery Remote Functions, Gemini AI, Cloud Functions
**Key Features**: SQL-native AI integration, Scalable processing, Custom model configurations and proper error handling

### 🔄 Real-Time Data Pipelines

#### **[audio-transcribe-go](https://github.com/johanesalxd/audio-transcribe-go)** - Speech-to-Text Service
...
**Tech Stack**: Go, Google Speech-to-Text API, BigQuery Remote Functions, Cloud Functions
**Key Features**: BigQuery integration, Multiple deployment options, Comprehensive testing, Production-ready
